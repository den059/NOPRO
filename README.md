...
Скачайте:
NOPRO_Setup.exe - сама программа
теги.docx - все теги используются самой программой в админ панели
Это настройки для загрузки, так же вы сами можете составить и сохранить, файлы:
prompts_txt.json - пример с промптами 
prompts_backup_null.json - с пустыми полями в админке
